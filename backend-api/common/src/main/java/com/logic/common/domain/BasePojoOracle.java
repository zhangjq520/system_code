...
import com.logic.common.service.IErrorMessage;
...
@ApiModel(description = "Base Pojo.")
public class BasePojoOracle implements Serializable {
  ...
  @ApiModelProperty(value = "Not required when create, but it's required when update")
  ...
  public void updateCommonInfo(Integer userId) {
    ...
    if (this.getId() == null || this.getId().compareTo(BigDecimal.ZERO) == 0) { // New PoJo
      this.setVersion(0);
