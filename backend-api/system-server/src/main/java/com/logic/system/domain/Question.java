...
public class Question extends BasePojo {
  ...
  private List<QuestionReferenceItem> questionReferenceItems;

  private List<QuestionOptionalAnswer> questionOptionalAnswers;

  private List<QuestionCategory> questionCategories;

  private List<OrgQuestion> orgQuestions;
  ...
  public List<QuestionReferenceItem> getQuestionReferenceItems() {
    return questionReferenceItems;
  }

  public void setQuestionReferenceItems(List<QuestionReferenceItem> questionReferenceItems) {
    this.questionReferenceItems = questionReferenceItems;
  }

  public List<QuestionOptionalAnswer> getQuestionOptionalAnswers() {
    return questionOptionalAnswers;
  }

  public void setQuestionOptionalAnswers(List<QuestionOptionalAnswer> questionOptionalAnswers) {
    this.questionOptionalAnswers = questionOptionalAnswers;
  }
  ...
  public List<OrgQuestion> getOrgQuestions() {
    return orgQuestions;
  }

  public void setOrgQuestions(List<OrgQuestion> orgQuestions) {
