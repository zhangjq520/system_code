...
public class CsvMapperConfig {
    ...
    public PojoAttributeMapping getAttributeMapping(@SuppressWarnings("rawtypes") Class aClass) {
        for( @SuppressWarnings("rawtypes") Class mappedClass : _pojoAttibutes.keySet() ) {
        ...
        if( !pojoDefault ) {           
            ...
            if( _pojoClasses != null ) {
                for(@SuppressWarnings("rawtypes") Class pojoClass : _pojoClasses) {
                    if( aClass == pojoClass )  {
            ...
            if( _toStringClasses != null ) {
                for(@SuppressWarnings("rawtypes") Class strClass : _toStringClasses) {
                    if( aClass == strClass )  {
                        needDefaultClass = true;
                        break;
                    }
     ...
     */
    public void setAttributeMapping(@SuppressWarnings("rawtypes") Class aClass, PojoAttributeMapping pojoAttributeMapping) {
     ...
     */
    @SuppressWarnings("unchecked")
    public boolean needsToString(@SuppressWarnings("rawtypes") Class aClass) {
        // Explicitly string?
        if( _toStringClasses != null ) {
            for( @SuppressWarnings("rawtypes") Class strClass : _toStringClasses ) {
     ...
     */
    public void setToStringClasses(@SuppressWarnings("rawtypes") Class ... toStringClasses) {
     ...
     */
    public void setPojoClasses(@SuppressWarnings("rawtypes") Class ... pojoClasses) {
    ...
    private PojoAttributeMapping getDefaultPojoMapping(@SuppressWarnings("rawtypes") Class aClass) {
