...
@Configuration
@Component
public class LogicMailSenderInfo implements EnvironmentAware {
	Logger log = LoggerFactory.getLogger(LogicMailSenderInfo.class);
	...
	public LogicMailSenderInfo() {
//		SysCache cache = SysCache.getInstance();
	}

	public LogicMailSenderInfo(String toAddress) {
	...
	public LogicMailSenderInfo(String toAddress, String subject, String content) {
		this(toAddress);
	...
	public LogicMailSenderInfo(String toAddress, String ccAddress, String replyTo,
							   String bccAddress) {
		this(toAddress);
	...
	public String toString() {
		String ret = "LogicMailSenderInfo[ to:" + this.toAddress + ", ";
	...
	public static LogicMailSenderInfo getDefaultMailInfo(String toAddress, String optBccAddress) throws Exception{
		LogicMailSenderInfo mailInfo = new LogicMailSenderInfo(toAddress);
