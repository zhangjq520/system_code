...
public class LogicSimpleMailSender {
	private static Logger logger = LoggerFactory.getLogger(LogicSimpleMailSender.class);

	public static boolean sendHtmlMail(LogicMailSenderInfo mailInfo) {
		logger.info("Send html email..");
		LogicMyAuthenticator authenticator = null;
		Properties pro = mailInfo.getProperties();
		if (mailInfo.isValidate()) {
			authenticator = new LogicMyAuthenticator(mailInfo.getUserName(),
		...
		Session sendMailSession = Session
			...
			//TODO call ICS API to send mail
