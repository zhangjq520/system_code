...
(
   code                 varchar(50) not null comment '主键：代码',
...
(
   id                   int not null auto_increment comment '主键',
   first_name           varchar(50) not null comment '连系人名',
   last_name            varchar(50) not null comment '连系人姓',
   ...
   comment              varchar(254) comment '连系人备注',
   version              int not null default 0 comment '版本',
   created_dtm          datetime not null comment '创建时间',
   created_by           int comment '创建人ID',
   last_modified_dtm    datetime comment '最近修改时间',
...
(
   ...
   level                int not null default 9 comment '级别：0, 1, 2, 3, 4, 5',
