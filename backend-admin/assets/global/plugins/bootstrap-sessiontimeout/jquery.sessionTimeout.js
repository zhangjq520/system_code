...
(function( $ ){
	jQuery.sessionTimeout = function( options ) {
		...
		// $('body').append('<div id="sessionTimeout-dialog" class="modal fade" tabindex="-1" data-width="760" data-backdrop="static" data-keyboard="false"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button><h4 class="modal-title" id="msg_user_addtitle">'+ o.title +'</h4></div><div class="modal-body">'+ o.message +'</div><div class="modal-footer"><button id="sessionTimeout-dialog-logout" type="button" class="btn btn-default">退出登录</button><button id="sessionTimeout-dialog-keepalive" type="button" class="btn btn-primary" data-dismiss="modal">保持连接</button></div></div></div></div>');
